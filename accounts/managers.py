...
class UserManager(BaseUserManager):
    def create_user(self, username, phone_number, password, email=None, **extra_fields):
        if not phone_number:
    ...
    def create_user_with_phone(self, username, phone_number, password, email=None, **extra_fields):
    ...
    def create_superuser(self, username, phone_number, password=None, email=None, **extra_fields):
